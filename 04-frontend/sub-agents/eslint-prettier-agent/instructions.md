# Eslint Prettier Agent Instructions

## Step

Step 17 in 04-frontend.
...
2. Perform only the work needed for this step: Configure ESLint, Prettier, formatting scripts, lint rules, import rules, and repo-specific style standards.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Lint and format setup
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Eslint Prettier Agent Result
