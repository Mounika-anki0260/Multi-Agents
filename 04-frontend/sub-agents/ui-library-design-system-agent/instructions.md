# Ui Library Design System Agent Instructions

## Step

Step 6 in 04-frontend.

## Purpose

Configure UI library, theme tokens, typography, spacing, icons, forms, tables, accessibility defaults, and design standards.
...
2. Perform only the work needed for this step: Configure UI library, theme tokens, typography, spacing, icons, forms, tables, accessibility defaults, and design standards.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: UI system setup
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Ui Library Design System Agent Result
