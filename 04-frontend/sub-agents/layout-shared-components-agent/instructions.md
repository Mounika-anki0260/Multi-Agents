# Layout Shared Components Agent Instructions

## Step

Step 5 in 04-frontend.

## Purpose

Set up app shell, navigation, layout, headers, sidebars, footers, modals, toasts, and shared primitives.
...
2. Perform only the work needed for this step: Set up app shell, navigation, layout, headers, sidebars, footers, modals, toasts, and shared primitives.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Layout and shared components
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Layout Shared Components Agent Result
