# Page Screen Agent Instructions

## Step

Step 7 in 04-frontend.

## Purpose

Create pages/screens aligned to user journeys, requirements, and API contracts.
...
2. Perform only the work needed for this step: Create pages/screens aligned to user journeys, requirements, and API contracts.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Page and screen implementation
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Page Screen Agent Result
