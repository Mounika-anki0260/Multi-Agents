# Ui Component Test Agent Instructions

## Step

Step 16 in 04-frontend.
...
2. Perform only the work needed for this step: Add component and UI tests for rendering, interaction, validation, loading, error, and permission states.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: UI/component test coverage
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Ui Component Test Agent Result
