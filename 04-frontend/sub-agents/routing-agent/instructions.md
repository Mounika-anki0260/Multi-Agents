...
Step 4 in 04-frontend.

## Purpose

Configure routes, nested layouts, protected routes, redirects, route metadata, and navigation guards.
...
2. Perform only the work needed for this step: Configure routes, nested layouts, protected routes, redirects, route metadata, and navigation guards.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Routing setup
