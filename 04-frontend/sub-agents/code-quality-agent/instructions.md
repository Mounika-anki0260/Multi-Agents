# Code Quality Agent Instructions

## Step

Step 18 in 04-frontend.
...
2. Perform only the work needed for this step: Run build, tests, linting, formatting, static analysis, and coverage checks.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Code quality result
