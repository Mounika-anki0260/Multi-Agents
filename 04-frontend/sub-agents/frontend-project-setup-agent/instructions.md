# Frontend Project Setup Agent Instructions

## Step

Step 2 in 04-frontend.
...
2. Perform only the work needed for this step: Create or validate frontend project setup, dependency manager, build tool, scripts, environment handling, and developer commands.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Frontend project baseline
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Frontend Project Setup Agent Result
