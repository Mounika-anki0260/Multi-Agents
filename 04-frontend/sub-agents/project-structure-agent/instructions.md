...
Step 3 in 04-frontend.

## Purpose

Define feature-based, route-based, atomic, domain-based, layered, or existing project structure.
...
2. Perform only the work needed for this step: Define feature-based, route-based, atomic, domain-based, layered, or existing project structure.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Frontend structure map
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Project Structure Agent Result
