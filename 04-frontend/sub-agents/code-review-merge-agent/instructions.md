# Code Review Merge Agent Instructions

## Step

Step 21 in 04-frontend.
...
2. Perform only the work needed for this step: Support review comments, update code, rerun checks, and confirm merge readiness.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Merge readiness status
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Code Review Merge Agent Result
