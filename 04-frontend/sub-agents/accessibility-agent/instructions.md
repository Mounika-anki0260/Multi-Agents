...
Step 14 in 04-frontend.

## Purpose

Check keyboard navigation, focus management, semantic HTML, labels, ARIA where needed, color contrast, and screen reader behavior.
...
2. Perform only the work needed for this step: Check keyboard navigation, focus management, semantic HTML, labels, ARIA where needed, color contrast, and screen reader behavior.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Accessibility findings and fixes
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Accessibility Agent Result
