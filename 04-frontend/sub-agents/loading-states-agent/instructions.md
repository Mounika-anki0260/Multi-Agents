# Loading States Agent Instructions

## Step

Step 13 in 04-frontend.

## Purpose

Add loading, skeleton, progress, optimistic update, disabled action, and pending submission states.
...
2. Perform only the work needed for this step: Add loading, skeleton, progress, optimistic update, disabled action, and pending submission states.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Loading state coverage
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Loading States Agent Result
