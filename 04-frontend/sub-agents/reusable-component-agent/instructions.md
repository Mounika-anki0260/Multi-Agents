# Reusable Component Agent Instructions

## Step

Step 8 in 04-frontend.

## Purpose

Create reusable components for fields, tables, cards, dialogs, filters, actions, empty states, and error displays.
...
2. Perform only the work needed for this step: Create reusable components for fields, tables, cards, dialogs, filters, actions, empty states, and error displays.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Component library
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Reusable Component Agent Result
