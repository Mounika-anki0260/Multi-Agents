...
2. Perform only the work needed for this step: Fix SonarQube blocker, critical, vulnerability, duplication, and code smell issues.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: SonarQube remediation
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Sonarqube Fix Agent Result
