# Cicd Integration Agent Instructions

## Step

Step 9 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Integrate scans into CI/CD build, pull request validation, branch analysis, and release gates.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: CI/CD quality integration
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Cicd Integration Agent Result
