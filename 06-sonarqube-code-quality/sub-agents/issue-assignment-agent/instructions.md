# Issue Assignment Agent Instructions

## Step

Step 12 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Assign issues to owners by module, severity, category, or responsible team.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Issue assignment plan
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Issue Assignment Agent Result
