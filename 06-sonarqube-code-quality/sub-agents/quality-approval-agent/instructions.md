# Quality Approval Agent Instructions

## Step

Step 15 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Approve only after quality gate passes or documented waivers are accepted.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Quality approval status
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Quality Approval Agent Result
