# Rescan Agent Instructions

## Step

Step 14 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Re-run scan after remediation and compare quality gate results.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Re-scan result
