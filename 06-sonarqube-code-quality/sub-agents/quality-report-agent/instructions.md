# Quality Report Agent Instructions

## Step

Step 11 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Generate quality report with gate status, coverage, duplications, ratings, issues, and trends.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Quality report
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Quality Report Agent Result
