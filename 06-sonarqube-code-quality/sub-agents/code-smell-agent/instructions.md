# Code Smell Agent Instructions

## Step

Step 6 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Enable and review maintainability, complexity, naming, dead code, and code smell rules.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Code smell policy
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Code Smell Agent Result
