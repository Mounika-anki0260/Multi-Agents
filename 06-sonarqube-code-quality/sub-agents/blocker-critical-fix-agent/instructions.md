# Blocker Critical Fix Agent Instructions

## Step

Step 13 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Fix or guide remediation for blocker and critical issues first.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Critical remediation
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Blocker Critical Fix Agent Result
