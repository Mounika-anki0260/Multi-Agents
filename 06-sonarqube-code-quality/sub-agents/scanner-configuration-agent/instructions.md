# Scanner Configuration Agent Instructions

## Step

Step 3 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Configure scanner CLI, Maven, Gradle, .NET, npm scanner, or CI task/action based on repository stack.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Scanner configuration
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Scanner Configuration Agent Result
