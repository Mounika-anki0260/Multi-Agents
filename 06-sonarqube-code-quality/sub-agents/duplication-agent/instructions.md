# Duplication Agent Instructions

## Step

Step 8 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Enable duplicate code checks and define exclusions for generated code where justified.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Duplication policy
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Duplication Agent Result
