# Coverage Threshold Agent Instructions

## Step

Step 5 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Define coverage thresholds and connect unit, integration, frontend, and backend coverage report paths.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Coverage configuration
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Coverage Threshold Agent Result
