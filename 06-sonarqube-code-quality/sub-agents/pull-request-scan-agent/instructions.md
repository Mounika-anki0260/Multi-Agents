# Pull Request Scan Agent Instructions

## Step

Step 10 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Run or define pull request scan behavior, decoration, branch comparison, and failure conditions.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Pull request scan setup
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Pull Request Scan Agent Result
