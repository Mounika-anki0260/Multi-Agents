...
Step 4 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Configure quality gate conditions for reliability, security, maintainability, coverage, duplication, and new-code policy.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Quality gate definition
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Quality Gate Agent Result
