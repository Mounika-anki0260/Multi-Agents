# Quality Setup Questionnaire Agent Instructions

## Step

Step 1 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Ask SonarQube/SonarCloud choice, project key, organization, languages, scanner, thresholds, coverage reports, branches, ownership, and exclusions.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Quality setup decisions
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Quality Setup Questionnaire Agent Result
