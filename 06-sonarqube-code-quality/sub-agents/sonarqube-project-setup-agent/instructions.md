# Sonarqube Project Setup Agent Instructions

## Step

Step 2 in 06-sonarqube-code-quality.
...
2. Perform only the work needed for this step: Set up or validate SonarQube project, project key, name, organization, permissions, and branch strategy.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: SonarQube project setup
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Sonarqube Project Setup Agent Result
