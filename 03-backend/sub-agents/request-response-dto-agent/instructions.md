# Request Response Dto Agent Instructions

## Step

Step 10 in 03-backend.

## Purpose

Add request DTOs, response DTOs, mappers, serialization rules, pagination, filtering, and sorting models.
...
2. Perform only the work needed for this step: Add request DTOs, response DTOs, mappers, serialization rules, pagination, filtering, and sorting models.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: DTO and mapping layer
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Request Response Dto Agent Result
