# Logging Agent Instructions

## Step

Step 14 in 03-backend.
...
2. Perform only the work needed for this step: Add structured logging, correlation IDs, request tracing, audit logs, and sensitive-data masking.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Logging implementation
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Logging Agent Result
