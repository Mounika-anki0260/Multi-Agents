# Folder Package Structure Agent Instructions

## Step

Step 3 in 03-backend.

## Purpose

Define package/folder structure by feature, layer, clean architecture, hexagonal architecture, modular monolith, microservice, or existing pattern.
...
2. Perform only the work needed for this step: Define package/folder structure by feature, layer, clean architecture, hexagonal architecture, modular monolith, microservice, or existing pattern.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Backend structure map
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Folder Package Structure Agent Result
