# Exception Handling Agent Instructions

## Step

Step 13 in 03-backend.
...
2. Perform only the work needed for this step: Add global exception handling, error contracts, domain exceptions, validation errors, and audit-safe error messages.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Error handling layer
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Exception Handling Agent Result
