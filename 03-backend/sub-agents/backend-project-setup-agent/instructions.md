# Backend Project Setup Agent Instructions

## Step

Step 2 in 03-backend.
...
2. Perform only the work needed for this step: Create or validate backend project setup, dependencies, build tool, runtime configuration, and developer commands.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Backend project baseline
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Backend Project Setup Agent Result
