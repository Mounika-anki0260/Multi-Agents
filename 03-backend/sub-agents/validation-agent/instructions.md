...
Step 11 in 03-backend.

## Purpose

Add input validation, business validation, constraint messages, and validation tests.
...
2. Perform only the work needed for this step: Add input validation, business validation, constraint messages, and validation tests.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Validation layer
