# Environment Profile Agent Instructions

## Step

Step 4 in 03-backend.
...
2. Perform only the work needed for this step: Configure local, dev, QA/UAT, staging, and production profiles using environment-safe configuration.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Environment profile setup
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Environment Profile Agent Result
