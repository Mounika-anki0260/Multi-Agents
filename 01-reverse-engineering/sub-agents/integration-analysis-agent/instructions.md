# Integration Analysis Agent Instructions

## Step

Step 8 in 01-reverse-engineering-documents.
...
2. Perform only the work needed for this step: Identify third-party systems, API calls, queues, files, events, protocols, retries, and failure handling.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Integration inventory
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Integration Analysis Agent Result
