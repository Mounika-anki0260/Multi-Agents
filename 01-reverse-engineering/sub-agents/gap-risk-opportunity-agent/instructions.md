# Gap Risk Opportunity Agent Instructions

## Step

Step 13 in 01-reverse-engineering-documents.

## Purpose

Prepare gaps, risks, constraints, technical debt, modernization opportunities, and open questions.
...
2. Perform only the work needed for this step: Prepare gaps, risks, constraints, technical debt, modernization opportunities, and open questions.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Gap, risk, and modernization opportunity report
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Gap Risk Opportunity Agent Result
