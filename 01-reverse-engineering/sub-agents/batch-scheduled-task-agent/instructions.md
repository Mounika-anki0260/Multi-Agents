# Batch Scheduled Task Agent Instructions

## Step

Step 9 in 01-reverse-engineering-documents.
...
2. Perform only the work needed for this step: Identify cron jobs, schedulers, background workers, ETL jobs, reports, and operational scripts.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Batch and scheduled task catalog
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Batch Scheduled Task Agent Result
