# Business Workflow Agent Instructions

## Step

Step 4 in 01-reverse-engineering-documents.

## Purpose

Understand actors, roles, workflows, business rules, approvals, exception paths, and operational journeys.
...
2. Perform only the work needed for this step: Understand actors, roles, workflows, business rules, approvals, exception paths, and operational journeys.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Business workflow map
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Business Workflow Agent Result
