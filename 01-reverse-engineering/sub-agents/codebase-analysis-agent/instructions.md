# Codebase Analysis Agent Instructions

## Step

Step 2 in 01-reverse-engineering-documents.
...
2. Perform only the work needed for this step: Analyze current source structure, languages, frameworks, build tools, dependencies, configuration, and entry points.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Codebase analysis summary
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Codebase Analysis Agent Result
