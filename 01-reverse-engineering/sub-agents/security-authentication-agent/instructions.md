# Security Authentication Agent Instructions

## Step

Step 10 in 01-reverse-engineering-documents.
...
2. Perform only the work needed for this step: Capture identity provider, login/logout, sessions, tokens, roles, permissions, policies, secrets, and certificates.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Security and auth flow
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Security Authentication Agent Result
