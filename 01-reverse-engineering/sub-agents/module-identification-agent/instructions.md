# Module Identification Agent Instructions

## Step

Step 3 in 01-reverse-engineering-documents.
...
2. Perform only the work needed for this step: Identify application modules, packages, features, domains, shared libraries, generated code, and ownership boundaries.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Module inventory
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Module Identification Agent Result
