# Frontend Screen Navigation Agent Instructions

## Step

Step 5 in 01-reverse-engineering-documents.

## Purpose

Identify frontend routes, screens, forms, navigation paths, UI components, client state, and API usage.
...
2. Perform only the work needed for this step: Identify frontend routes, screens, forms, navigation paths, UI components, client state, and API usage.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Screen and navigation catalog
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Frontend Screen Navigation Agent Result
