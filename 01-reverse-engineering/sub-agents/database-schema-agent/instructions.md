# Database Schema Agent Instructions

## Step

Step 7 in 01-reverse-engineering-documents.
...
2. Perform only the work needed for this step: Analyze tables, views, collections, relationships, constraints, indexes, migrations, stored logic, and data ownership.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Database schema documentation
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Database Schema Agent Result
