# Document Intake Agent Instructions

## Step

Step 1 in 01-reverse-engineering-documents.
...
2. Perform only the work needed for this step: Collect existing documents, README files, architecture notes, API specs, database docs, deployment guides, and test plans.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Source document inventory
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Document Intake Agent Result
