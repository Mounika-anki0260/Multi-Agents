# As Is Architecture Writer Agent Instructions

## Step

Step 12 in 01-reverse-engineering-documents.
...
2. Perform only the work needed for this step: Prepare the As-Is Architecture Document using evidence from prior sub-agents.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: As-Is Architecture Document
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# As Is Architecture Writer Agent Result
