# Backend Architecture Agent Instructions

## Step

Step 8 in 02-redesign-rearchitecture-documents.

## Purpose

Define backend modules, APIs, services, repositories, DTOs, validation, security, errors, logging, and background processing.
...
2. Perform only the work needed for this step: Define backend modules, APIs, services, repositories, DTOs, validation, security, errors, logging, and background processing.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Backend architecture
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Backend Architecture Agent Result
