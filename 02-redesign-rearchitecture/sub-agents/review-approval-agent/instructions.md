# Review Approval Agent Instructions

## Step

Step 16 in 02-redesign-rearchitecture-documents.

## Purpose

Prepare review comments, approval checklist, decision log, risks, assumptions, and open items.
...
2. Perform only the work needed for this step: Prepare review comments, approval checklist, decision log, risks, assumptions, and open items.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Review and approval package
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Review Approval Agent Result
