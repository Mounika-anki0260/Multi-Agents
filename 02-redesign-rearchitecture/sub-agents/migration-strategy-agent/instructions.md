# Migration Strategy Agent Instructions

## Step

Step 13 in 02-redesign-rearchitecture-documents.

## Purpose

Define migration waves, coexistence, data migration, cutover, rollback, dependency sequencing, and release strategy.
...
2. Perform only the work needed for this step: Define migration waves, coexistence, data migration, cutover, rollback, dependency sequencing, and release strategy.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Migration strategy
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Migration Strategy Agent Result
