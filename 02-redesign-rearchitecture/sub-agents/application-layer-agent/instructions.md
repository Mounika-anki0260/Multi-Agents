...
Step 6 in 02-redesign-rearchitecture-documents.

## Purpose

Define application layers, responsibilities, boundaries, dependency direction, and shared cross-cutting concerns.
...
2. Perform only the work needed for this step: Define application layers, responsibilities, boundaries, dependency direction, and shared cross-cutting concerns.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Application layer model
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Application Layer Agent Result
