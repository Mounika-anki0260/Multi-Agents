# Architecture Decision Agent Instructions

## Step

Step 4 in 02-redesign-rearchitecture-documents.

## Purpose

Capture the user's selected architecture style or approved hybrid and record rationale.
...
2. Perform only the work needed for this step: Capture the user's selected architecture style or approved hybrid and record rationale.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Architecture decision record
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Architecture Decision Agent Result
