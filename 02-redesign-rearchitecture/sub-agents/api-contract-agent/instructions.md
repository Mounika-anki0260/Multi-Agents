...
Step 10 in 02-redesign-rearchitecture-documents.

## Purpose

Define API endpoints or operations, request and response models, status codes, errors, auth requirements, and versioning.
...
2. Perform only the work needed for this step: Define API endpoints or operations, request and response models, status codes, errors, auth requirements, and versioning.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: API contract specification
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Api Contract Agent Result
