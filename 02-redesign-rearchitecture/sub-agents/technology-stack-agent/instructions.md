# Technology Stack Agent Instructions

## Step

Step 5 in 02-redesign-rearchitecture-documents.

## Purpose

Define or validate frontend, backend, database, integration, hosting, identity, observability, and reporting technologies with versions.
...
2. Perform only the work needed for this step: Define or validate frontend, backend, database, integration, hosting, identity, observability, and reporting technologies with versions.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Target technology stack
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Technology Stack Agent Result
