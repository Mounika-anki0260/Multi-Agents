# As Is Context Reader Agent Instructions

## Step

Step 2 in 02-redesign-rearchitecture-documents.
...
2. Perform only the work needed for this step: Read As-Is architecture, reverse engineering findings, gaps, risks, workflows, APIs, database, integrations, security, and deployment context.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Current-state context summary
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# As Is Context Reader Agent Result
