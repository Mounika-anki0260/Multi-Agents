...
Step 7 in 02-redesign-rearchitecture-documents.

## Purpose

Define frontend routes, modules, layouts, components, state management, API clients, validation, accessibility, and build approach.
...
2. Perform only the work needed for this step: Define frontend routes, modules, layouts, components, state management, API clients, validation, accessibility, and build approach.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Frontend architecture
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Frontend Architecture Agent Result
