# Architecture Style Options Agent Instructions

## Step

Step 3 in 02-redesign-rearchitecture-documents.

## Purpose

Propose suitable architecture styles such as layered, modular monolith, microservices, event-driven, serverless, strangler, or hybrid.
...
2. Perform only the work needed for this step: Propose suitable architecture styles such as layered, modular monolith, microservices, event-driven, serverless, strangler, or hybrid.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Architecture style options
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Architecture Style Options Agent Result
