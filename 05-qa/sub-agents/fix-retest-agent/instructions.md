...
2. Perform only the work needed for this step: Retest fixed defects, verify regression impact, and update defect status.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Retest report
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Fix Retest Agent Result
