# Requirements Analysis Agent Instructions
...
2. Perform only the work needed for this step: Understand requirements, user stories, acceptance criteria, NFRs, risks, and release scope.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Requirement-to-test traceability
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Requirements Analysis Agent Result
