# Qa Setup Questionnaire Agent Instructions
...
2. Perform only the work needed for this step: Ask testing scope, tools, script structure, environments, test data, entry/exit criteria, devices, defect process, performance targets, and sign-off evidence.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: QA setup decisions
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Qa Setup Questionnaire Agent Result
