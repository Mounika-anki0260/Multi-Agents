# Negative Testing Agent Instructions
...
2. Perform only the work needed for this step: Execute invalid input, unauthorized access, boundary, failure, timeout, and error-path tests.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Negative test results
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Negative Testing Agent Result
