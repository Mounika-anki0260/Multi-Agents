# Functional Testing Agent Instructions
...
Execute functional tests against requirements and acceptance criteria.
...
2. Perform only the work needed for this step: Execute functional tests against requirements and acceptance criteria.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Functional test results
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Functional Testing Agent Result
