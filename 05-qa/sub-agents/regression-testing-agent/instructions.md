...
2. Perform only the work needed for this step: Execute regression suite for impacted and high-risk existing behavior.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Regression test results
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Regression Testing Agent Result
