# Frontend Ui Testing Agent Instructions
...
2. Perform only the work needed for this step: Execute UI tests for screens, navigation, forms, errors, loading, accessibility basics, and browser behavior.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: UI test results
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Frontend Ui Testing Agent Result
