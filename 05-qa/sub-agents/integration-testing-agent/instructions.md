...
2. Perform only the work needed for this step: Execute integration tests across frontend, backend, database, external systems, queues, files, and batch jobs.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Integration test results
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Integration Testing Agent Result
