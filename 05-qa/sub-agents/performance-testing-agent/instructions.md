...
2. Perform only the work needed for this step: Execute performance tests where required for response time, throughput, concurrency, error rate, and resource usage.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Performance test results
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Performance Testing Agent Result
