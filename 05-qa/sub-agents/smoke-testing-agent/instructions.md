# Smoke Testing Agent Instructions
...
2. Perform only the work needed for this step: Execute smoke checks after deployment or build promotion.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Smoke test results
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Smoke Testing Agent Result
