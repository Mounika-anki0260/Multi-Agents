...
2. Perform only the work needed for this step: Provide go/no-go recommendation based on exit criteria, open defects, risk acceptance, and approval evidence.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: QA sign-off
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Qa Signoff Agent Result
