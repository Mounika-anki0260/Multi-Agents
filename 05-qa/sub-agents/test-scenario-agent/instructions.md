# Test Scenario Agent Instructions
...
2. Perform only the work needed for this step: Prepare end-to-end scenarios by feature, role, API, workflow, integration, and risk area.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Test scenarios
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Test Scenario Agent Result
