# Qa Uat Deployment Agent Instructions

## Step

Step 14 in 07-cicd-pipeline.
...
2. Perform only the work needed for this step: Deploy to QA/UAT/staging environments and coordinate test readiness.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: QA/UAT deployment
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Qa Uat Deployment Agent Result
