...
2. Perform only the work needed for this step: Run integration tests, service containers, database setup, API checks, and publish results.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Integration test step
