# Production Deployment Agent Instructions

## Step

Step 16 in 07-cicd-pipeline.
...
2. Perform only the work needed for this step: Deploy to production using the approved strategy and record version, environment, and deployment status.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Production deployment
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Production Deployment Agent Result
