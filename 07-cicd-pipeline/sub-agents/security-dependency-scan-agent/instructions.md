# Security Dependency Scan Agent Instructions

## Step

Step 9 in 07-cicd-pipeline.
...
2. Perform only the work needed for this step: Run dependency, secret, SAST, container, and IaC scans as required.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Security scan step
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Security Dependency Scan Agent Result
