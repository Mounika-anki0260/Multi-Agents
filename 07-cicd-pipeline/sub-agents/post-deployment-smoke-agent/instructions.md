# Post Deployment Smoke Agent Instructions

## Step

Step 17 in 07-cicd-pipeline.
...
2. Perform only the work needed for this step: Run smoke tests after deployment and fail or alert on critical failures.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Smoke test result
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Post Deployment Smoke Agent Result
