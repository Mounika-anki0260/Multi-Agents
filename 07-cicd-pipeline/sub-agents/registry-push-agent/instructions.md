# Registry Push Agent Instructions

## Step

Step 12 in 07-cicd-pipeline.
...
2. Perform only the work needed for this step: Push packages, artifacts, Docker images, or Helm charts to the configured registry.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Published artifact/image
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Registry Push Agent Result
