# Rollback Agent Instructions

## Step

Step 18 in 07-cicd-pipeline.
...
2. Perform only the work needed for this step: Define rollback process using previous artifact, blue/green, canary, feature flag, or manual rollback steps.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Rollback plan
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Rollback Agent Result
