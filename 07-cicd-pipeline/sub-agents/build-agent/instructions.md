...
2. Perform only the work needed for this step: Run backend, frontend, library, container, or static build commands.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Build step
