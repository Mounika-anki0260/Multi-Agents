...
2. Perform only the work needed for this step: Notify team on success, failure, approval waiting, rollback, and release completion.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Notification setup
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Notification Agent Result
