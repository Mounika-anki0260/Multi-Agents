# Artifact Generation Agent Instructions

## Step

Step 10 in 07-cicd-pipeline.
...
2. Perform only the work needed for this step: Package build outputs, version artifacts, attach metadata, and publish artifacts.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Build artifact
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Artifact Generation Agent Result
