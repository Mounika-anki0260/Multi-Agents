# Production Approval Agent Instructions

## Step

Step 15 in 07-cicd-pipeline.
...
2. Perform only the work needed for this step: Add production approval gate with required reviewers, checks, and risk acceptance.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Production approval gate
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Production Approval Agent Result
