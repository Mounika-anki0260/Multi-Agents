# Docker Image Agent Instructions

## Step

Step 11 in 07-cicd-pipeline.
...
2. Perform only the work needed for this step: Build Docker images, tag with version/commit, scan image, and prepare for registry push when required.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Docker image
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Docker Image Agent Result
