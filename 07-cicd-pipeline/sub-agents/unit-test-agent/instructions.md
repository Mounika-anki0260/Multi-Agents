...
2. Perform only the work needed for this step: Run unit tests and publish results and coverage.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Unit test step
