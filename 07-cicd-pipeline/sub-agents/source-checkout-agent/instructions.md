# Source Checkout Agent Instructions

## Step

Step 3 in 07-cicd-pipeline.
...
2. Perform only the work needed for this step: Configure repository checkout, branch filters, pull request triggers, tags, submodules, and permissions.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Source checkout setup
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Source Checkout Agent Result
