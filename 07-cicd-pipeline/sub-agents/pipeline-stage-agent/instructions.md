# Pipeline Stage Agent Instructions

## Step

Step 2 in 07-cicd-pipeline.
...
2. Perform only the work needed for this step: Define stages, dependencies, conditions, parallel jobs, environment promotions, and failure behavior.
3. Capture source evidence, decisions, assumptions, risks, and open questions.
4. Produce the primary output: Pipeline stage design
5. Hand off concise, structured results to the next sub-agent.

## Output Format

~~~markdown
# Pipeline Stage Agent Result
